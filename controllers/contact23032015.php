...
class Contact extends CI_Controller {
	...
	{	
		...
		//$this->session->set_userdata('succ_update_contact','<span class="success">Thank you ! Your message has been successfully sent. We will contact you very soon!</span>');
	...
	{	
		...
		<div> </div>
			...
			//$this->contactmodel->insert_record_requestform_mariage($currentid);
			$admindetails  = $this->commonlibmodel->getgeneralsetting();
			...
			//$this->session->set_userdata('succ_update_contact_maries','<span class="success">Thank you ! Your message has been successfully sent. We will contact you very soon!</span>');
			redirect('confirmation-demande-de-devis');
		/*}
		else
		{
			redirect('notre-agence/maries-et-mariage');
		}*/
	}
	...
	function requestquotefrm()
	{
		...
		$this->contactmodel->insert_record_requestform_allfield($currentid,$pageurls);
...
<div>Une conseillère reviendra vers vous dans les plus brefs délais.</div>
		...
		$pageurls = $_SERVER['HTTP_REFERER'];
		$this->contactmodel->insert_record_requestform_prodestination($currentid,$pageurls);
