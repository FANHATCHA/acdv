				...
				$return_res.='<div class="product_details"><div class="pro_thumb_image">
							<a href="'.$productdetailslink.'">';
									if(isset($productdetails[0]["featured_image"]) && !empty($productdetails[0]["featured_image"])){
										$return_res .= '<img width="250" height="250" src="'.$this->config->site_url().'application/uploads/product/featuredimage/original/'.$productdetails[0]['featured_image'].'" border="0" title="'.$productdetails[0]['product_name'].'" alt="'.$productdetails[0]['product_name'].'">';
									}else{ 
										$return_res .= '<img width="250" height="250" src="'.$this->config->site_url().'application/uploads/no_image250.jpg" alt="'.$productdetails[0]['product_name'].'" title="'.$productdetails[0]["product_name"].'" border="0">';
									}
								$return_res .='
						...
						$return_res .='<div class="product_details"><div class="pro_thumb_image">
							<a href="'.$productdetailslink.'">';
									if(isset($productdetails[0]["featured_image"]) && !empty($productdetails[0]["featured_image"])){
										...
										$return_res .= '<img width="250" height="250" src="'.$this->config->site_url().'application/uploads/no_image250.jpg&h=250" alt="'.$productdetails[0]['product_name'].'" title="'.$productdetails[0]["product_name"].'" border="0">';
									}
								$return_res .='
							</a></div><div class="pro_thumb_image_right">
							<h2><a href="'.$productdetailslink.'">
			...
			foreach($results as $clientreview_datas)
			{
				...
				$return_res .='<div class="clientreview_details_row"><div class="clientreview_details_cols">';
						if(isset($clientreview_datas["client_review_image"]) && !empty($clientreview_datas["client_review_image"])){
							$return_res .= '<img width="250" height="250" border="0" src="'.$this->config->site_url().'application/uploads/clientreview/original/'.$clientreview_datas['client_review_image'].'" alt="'.$clientreview_datas['name'].'" title="'.$clientreview_datas['name'].'">';
						}else{ 
							$return_res .= '<img  width="250px" height="250px" src="'.$this->config->site_url().'application/uploads/no_image250.jpg" alt="'.$clientreview_datas['name'].'" title="'.$clientreview_datas['name'].'" border="0">';
						}
				$return_res .='</div>';
			...
			foreach($results as $blogdata)
			{
				...
				$return_res .='<div class="clientreview_details_row"><div class="clientreview_details_cols">';
						if(isset($blogdata['featured_image']) && !empty($blogdata['featured_image'])){
							$return_res .='<a href="'.$singlebloglink.'" title="'.$blogdata['blog_title'].'"><img width="250" height="250" border="0" src="'.$this->config->site_url().'application/uploads/blog/featuredimage/original/'.$blogdata['featured_image'].'"></a>';
						}else{
							$return_res .= '<img width="250" height="250" src="'.$this->config->site_url().'application/uploads/no_image250.jpg" alt="'.$blogdata['blog_title'].'" title="'.$blogdata["blog_title"].'" border="0">';
