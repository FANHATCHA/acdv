...
Class Contactmodel extends CI_Model
{
	...
	function insert_record_simplerequestform_allfield($currentid,$pageurls)
	{
		header('Content-Type: text/html; charset=utf-8');
		...
		$startdate = date('Y-m-d H:i:s',strtotime($from_arr[2]."-".$from_arr[1]."-".$from_arr[0]));
		$enddate   = date('Y-m-d H:i:s',strtotime($to_arr[2]."-".$to_arr[1]."-".$to_arr[0]));
	...
	function insert_record_simplerequestform_prodestination($currentid,$pageurls)
	{
		$this->form_validation->set_rules('name','name','trim|required');
		//$this->form_validation->set_rules('firstname','firstname', 'trim|required');
		$this->form_validation->set_rules('email', 'email','trim|required|valid_email');
