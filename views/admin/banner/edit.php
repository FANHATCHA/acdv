			...
			<div class="tab-pane" id="tab_7">
				 <div class="portlet box green ">
					  ...
					  <div class="portlet-body form">
						 <form action="<?php echo $this->config->site_url();?>admin/banner/update" class="form-horizontal form-bordered form-label-stripped" enctype="multipart/form-data" method="post" id="bannerfrm" name="bannerfrm">
							<?php
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											...
											<span class="imagelist">
												<?php   foreach($bannerimagedata as $bannerdata){ ?>
													<div class="image_maindiv" id="<?php echo $bannerdata['banner_image']; ?>" style="display:block">
														<img  src='<?php echo $this->config->site_url()?>timthumb.php?src=<?php echo $this->config->base_url()?>application/uploads/bannerimages/original/<?php echo $bannerdata['banner_image']?>&h=100&w=100&c=1' border="0" alt="<?php echo $bannerdata['banner_image'];?>">
														<a class="image_removediv"onclick="removeimage('<?php echo $bannerdata['banner_image']; ?>')" ><span><i class="fa fa-trash-o"></i></span></a>
													</div>
												<?php } ?>
											</span>
										</div>
