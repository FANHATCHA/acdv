		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					<?php echo $this->lang->line('BANNER_TITLES');?> 
					</h3>
			...
			<div class="row">
				...
				<div class="portlet box green">
						...
						<div class="portlet-body">
							...
							<div class="table-toolbar">
								...
								<div class="btn-group pull-right">
									...
									<ul class="dropdown-menu pull-right">
										<li>
											<a onClick="return confirm_multiple('banner');">
												 <?php echo $this->lang->line('DELETE_ALL');?>
											</a>
										</li>
										<li>
											<a onClick="return confirm_active('banner');">
												 <?php echo $this->lang->line('ACTIVE_ALL');?>
											</a>
										</li>
										<li>
											<a onClick="return confirm_inactive('banner');">
							...
							<form action="<?php echo $this->config->site_url();?>admin/banner/delete" method="post" name="actionfrm" id="actionfrm">
								<table class="table table-striped table-bordered table-hover"  id="sample_2">
									<thead>
										<tr>
											...
											<th class="head1" width="5%"><?php echo $this->lang->line('ORDER');?></th>
											<th class="head1" width="15%"><?php echo $this->lang->line('STATUS');?></th>
											<th class="head1" width="13%"><?php echo $this->lang->line('ACTIONS');?></th>
											<th class="head1" width="2%">ID</th>
										</tr>
									</thead>
									<tbody>
										<?php 	foreach($bannerdata_list as $result){ ?>
											<tr class="odd gradeX">
												...
												<td>
												<a onclick="return confirm('<?php echo $this->lang->line('STATUS_COMFIRM'); ?>');"style="text-decoration: none;" href="<?php echo $this->config->site_url();?>admin/banner/update_status?id=<?php echo $result['id'];?>">
												...
												<td>
													<a href="<?php  echo $this->config->site_url();?>admin/banner/edit?id=<?php echo $result["id"]; ?>" class="btn default btn-xs green-stripe"><i class="fa fa-edit"></i> Edit</a>
													<a onclick="return confirm('<?php echo $this->lang->line('DELETE_COMFIRM'); ?>');"  href="<?php  echo $this->config->site_url();?>admin/banner/delete?id=<?php echo $result["id"]; ?>" class="btn default btn-xs green-stripe"><i class="fa fa-trash-o"></i> Delete</a>
												</td>
