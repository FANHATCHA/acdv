		...
		<div class="page-content">
			...
			<div class="tab-pane" id="tab_7">
				 <div class="portlet box green ">
					...
					<form action="<?php echo $this->config->site_url();?>admin/blogcategory/update" class="form-horizontal form-bordered form-label-stripped" id="blogcatfrm" name="blogcatfrm" method="post" enctype="multipart/form-data">
						<?php
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<select name="parent_id" id="parent_id" class="form-control select2me">
											...
											<option value="<?php echo $productcat['category_id'];?>" <?php if($productcat['category_id'] == $formdata['parent_id']) echo "selected";?>><?php echo $productcat['category_name']; ?></option>
											<?php } ?>
									</select>
									<span class="help-block">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<select name="slider" id="slider" class="form-control select2me">
											...
											<option value="<?php echo $sliderdetails->id;?>" <?php if(isset($formdata['slider']) && !empty($formdata['slider']) && $formdata['slider'] == $sliderdetails->id){ echo ' selected="selected"';} ?> >
