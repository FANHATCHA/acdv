		...
		<div class="page-content">
			...
			<div class="tab-pane" id="tab_7">
				 <div class="portlet box green ">
					...
					<form action="<?php echo $this->config->site_url();?>admin/clientreview/add" class="form-horizontal form-bordered form-label-stripped" id="clientreviewfrm" name="clientreviewfrm" method="post" enctype="multipart/form-data">
						<?php
						...
						<div class="form-body">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<select class="form-control"  style="height: 182px;" name="destination_id[]" id="destination_id" multiple="">
