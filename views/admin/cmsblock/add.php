		...
		<div class="page-content">
			...
			<div class="tab-pane" id="tab_7">
				 <div class="portlet box green ">
					...
					<form action="<?php echo $this->config->site_url();?>admin/cmsblock/add" class="form-horizontal form-bordered form-label-stripped" id="cmsblockfrm" name="cmsblockfrm" method="post" enctype="multipart/form-data">
