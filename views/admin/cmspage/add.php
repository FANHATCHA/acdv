		...
		<div class="page-content">
			...
			<div class="tab-pane" id="tab_7">
				 <div class="portlet box green ">
					...
					<form action="<?php echo $this->config->site_url();?>admin/cmspage/add" class="form-horizontal form-bordered form-label-stripped" id="seofrm" name="seofrm" method="post" enctype="multipart/form-data">
						<?php
