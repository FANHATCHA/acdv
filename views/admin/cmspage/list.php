			...
			<div class="row">
				<div class="col-md-12">
					...
					<?php 
							...
							$update 	= $this->session->userdata('updatescc');
					 ...
					 <?php } if(isset($succ_update) && !empty($succ_update)){ ?>
						<div class="alert alert-success">
							<button class="close" data-dismiss="alert">×</button>
							<strong><?php echo $this->lang->line('STATUS_UPDATE_SUCC');$this->session->unset_userdata('updatescc');?></strong>
						</div>
					 <?php }
					...
					<div class="portlet box green">
						...
						<div class="portlet-body">
							...
							<div class="table-toolbar">
								<div class="btn-group">
									<button id="sample_editable_1_new" class="btn green" onclick="window.location='<?php echo $this->config->site_url();?>admin/cmspage/add'" >
								...
								<div class="btn-group pull-right">
									...
									<ul class="dropdown-menu pull-right">
										<li>
											<a onClick="return confirm_multiple('cmspage');">
												 <?php echo $this->lang->line('DELETE_ALL');?>
											</a>
										</li>
										<li>
											<a onClick="return confirm_active('cmspage');">
												 <?php echo $this->lang->line('ACTIVE_ALL');?>
											</a>
										</li>
										<li>
											<a onClick="return confirm_inactive('cmspage');">
							...
							<table class="table table-striped table-bordered table-hover" id="sample_2">
								...
								<tbody>
									...
									<tr class="odd gradeX">
										...
										<td>
											<?php echo $cdata['cms_title']; ?>
										</td>
										<td>
											<?php echo $cdata['slug']; ?>
										</td>
										<td>
											<a onclick="return confirm('<?php echo $this->lang->line('STATUS_COMFIRM'); ?>');"style="text-decoration: none;" href="<?php echo $this->config->site_url();?>admin/cmspage/update_status?id=<?php echo $cdata['id'];?>">
										...
										<td>
											 <a href="<?php echo $this->config->site_url();?>admin/cmspage/edit?id=<?php echo $cdata['id'];?>" class="btn default btn-xs green-stripe"><i class="fa fa-edit"></i> Edit</a>
											 <a  onclick="return confirm('<?php echo $this->lang->line('DELETE_COMFIRM'); ?>');" href="<?php echo $this->config->site_url();?>admin/cmspage/delete?id=<?php echo $cdata['id'];?>" class="btn default btn-xs green-stripe"><i class="fa fa-trash-o"></i> Delete</a>
										</td>
									</tr>
									<?php } ?>
								</tbody>
