...
<div class="page-sidebar-wrapper">
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu" data-auto-scroll="true" data-slide-speed="200">
				...
				<!---=============== DASHBOARD ================--->
				<!---=============== MEDIA LIBRARY ================--->
				<li class="start <?php if($this->router->class =='medialibrary')echo 'active';?>">
					<a href="<?php echo $this->config->site_url();?>admin/medialibrary">
						<i class="fa fa-folder"></i>
						<span class="title">
							<?php echo $this->lang->line('MEDIALIBRARY');?>
						</span>
						<span class="arrow ">
						</span>
					</a>
					<ul class="sub-menu">
						<li class="<?php if($this->router->class =='medialibrary' && $this->router->method == 'add')echo 'active';?>">
							<a href="<?php echo $this->config->site_url();?>admin/medialibrary/add">
								<?php echo $this->lang->line('ADD_FILES');?>
							</a>
						</li>
						<li class="<?php if($this->router->class =='medialibrary' && $this->router->method != 'add')echo 'active';?>">
							<a href="<?php echo $this->config->site_url();?>admin/medialibrary">
				...
				<!---=============== MEDIA LIBRARY ================--->
				<!---=============== CONTENT ================--->
				<li class="<?php if($this->router->class =='cmspage' || $this->router->class =='userdetails' || $this->router->class =='cmsblock' || $this->router->class =='clientreview' || $this->router->class =='footer' || $this->router->class =='blogcategory' || $this->router->class =='blog' ||  $this->router->class =='product' || $this->router->class =='tags' || $this->router->class =='countdown' || $this->router->class =='product_category' || $this->router->class =='practicalinfo' || $this->router->class =='practicalinfocategory')echo 'active open';?>">
					<a href="javascript:;">
						<i class="fa fa-folder"></i>
						<span class="title">
					...
					<ul class="sub-menu">
						...
						<li class="<?php if($this->router->class =='product' || $this->router->class =='userdetails'  || $this->router->class =='tags' || $this->router->class =='countdown')echo 'active open';?>">
							<a href="javascript:;">
								<span class="title">
							...
							<ul class="sub-menu">
								...
								<li class="<?php if($this->router->class =='userdetails')echo 'active';?>">
									<a href="<?php echo $this->config->site_url();?>admin/userdetails">
										<?php echo $this->lang->line('USERDETAILS_MENU');?>
									</a>
								</li>
							...
							<ul class="sub-menu">
								...
								<li class="<?php if($this->router->class =='practicalinfo')echo 'active';?>">
									<a href="<?php echo $this->config->site_url();?>admin/practicalinfo">
										<?php echo $this->lang->line('PRODUCT_INFO_MENU_LEFT');?>
									</a>
								</li>
							</ul>
						</li>
						<li class="<?php if($this->router->class =='blogcategory' || $this->router->class =='blog')echo 'active open';?>">
							<a href="javascript:;">
								<span class="title">
							...
							<ul class="sub-menu">
								<li class="<?php if($this->router->class =='blog')echo 'active';?>">
									<a href="<?php echo $this->config->site_url();?>admin/blog">
										<?php echo $this->lang->line('BLOG_MENU');?>
									</a>
								</li>
								<li class="<?php if($this->router->class =='blogcategory')echo 'active';?>">
									<a href="<?php echo $this->config->site_url();?>admin/blogcategory">
										<?php echo $this->lang->line('BLOG_MENU_CAT_MENU');?>
									</a>
								</li>
							</ul>
						</li>
						<li class="<?php if($this->router->class =='cmspage')echo 'active';?>">
							<a href="<?php echo $this->config->site_url();?>admin/cmspage">
								<?php echo $this->lang->line('CMS_PAGE_MENU');?>
							</a>
						</li>
						<li class="<?php if($this->router->class =='cmsblock')echo 'active';?>">
							<a href="<?php echo $this->config->site_url();?>admin/cmsblock">
								<?php echo $this->lang->line('CMS_BLOCK_PAGE_MENU');?>
							</a>
						</li>
						<li class="<?php if($this->router->class =='footer')echo 'active';?>">
							<a href="<?php echo $this->config->site_url();?>admin/footer">
								<?php echo $this->lang->line('FOOTER');?>
							</a>
						</li>
						<li class="<?php if($this->router->class =='clientreview')echo 'active';?>">
							<a href="<?php echo $this->config->site_url();?>admin/clientreview">
								<?php echo $this->lang->line('CLIENT_REVIEW');?>
							</a>
						</li>
					</ul>
				</li>
				<!---=============== CONTENT ================--->
				<!---=============== CONFIGRATION ================--->
				<li class="<?php if($this->router->class =='setting' || $this->router->class =='slider' || $this->router->class =='quotation' || $this->router->class =='newsletter' || $this->router->class =='import' || $this->router->class =='backup' || $this->router->class =='redirect' || $this->router->class =='socialmedia' || $this->router->class =='banner' || $this->router->class =='menu' || $this->router->class =='menulink')echo 'active open';?>">
					<a href="javascript:;">
					...
					<ul class="sub-menu">
						...
						<li class="<?php if($this->router->class =='slider')echo 'active';?>">
							<a href="<?php echo $this->config->site_url();?>admin/slider">
								<?php echo $this->lang->line('SLIDER_MANAGEMENT');?>
							</a>
						</li>
					
						<li class="<?php if($this->router->class =='redirect' || $this->router->class =='import')echo 'active';?>">
						...
						<li class="<?php if($this->router->class =='quotation')echo 'active';?>">
							<a href="<?php echo $this->config->site_url();?>admin/quotation">
								<?php echo $this->lang->line('QUOTATION_MENU_MNG');?>
							</a>
						</li>
