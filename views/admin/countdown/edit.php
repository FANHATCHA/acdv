		...
		<div class="page-content">
			...
			<div class="tab-pane" id="tab_7">
				 <div class="portlet box green ">
					...
					<form action="<?php echo $this->config->site_url();?>admin/countdown/update" method="post" class="form-horizontal form-bordered form-label-stripped" id="countdownfrm" name="countdownfrm"  enctype="multipart/form-data"> 
						...
						<div class="form-body">
									...
									<div class="checkbox-list">
										<label>
											<div id="uniform-category">
												<span><input <?php if(isset($formdata['promoting_offers']) && !empty($formdata['promoting_offers'])) echo "checked='checked'";?> type="checkbox" value="1" name="promoting_offers" id="promoting_offers"></span>
											</div>
										</label>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<div class="input-group date form_datetime input-large" data-date="<?php echo $year; ?>-<?php echo $month; ?>-<?php echo $day; ?>T15:25:00Z">
										<input type="text" size="16"  class="form-control" id="start_date" name="start_date" value="<?php echo date('d F Y - h:i',strtotime($formdata['start_date']));?>">
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									...
									<div class="input-group date form_datetime input-large" data-date="<?php echo $year; ?>-<?php echo $month; ?>-<?php echo $day; ?>T15:25:00Z">
										<input type="text" size="16" class="form-control" id="end_date" name="end_date" value="<?php echo date('d F Y - h:i',strtotime($formdata['end_date']));?>">
										<span class="input-group-btn">
											<button class="btn default date-reset" type="button"><i class="fa fa-times"></i></button>
										</span>
										<span class="input-group-btn">
						...
						<input type="hidden" name="coutdown_id" id="coutdown_id" value="<?php echo $formdata['id'];?>">
					</form>
					<!-- END FORM-->
				</div>
			</div>
