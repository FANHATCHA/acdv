		...
		<div class="page-content">
			...
			<div class="tab-pane" id="tab_7">
				 <div class="portlet box green ">
					...
					<form action="<?php echo $this->config->site_url();?>admin/menu/add" class="form-horizontal form-bordered form-label-stripped" id="menufrm" name="menufrm" method="post" enctype="multipart/form-data">
						...
						<div class="form-body">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									...
									<span class="help-block">
										  <?php echo $this->lang->line('MENU_STATUS_HINT');?>
									</span>
								</div>
							</div>
