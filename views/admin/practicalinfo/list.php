		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
								<?php echo $this->lang->line('PROINFO_TITLE');?>
						</li>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<?php } /*if(isset($check_dups) && !empty($check_dups)){ ?>
						<div class="alert alert-success">
							<button class="close" data-dismiss="alert">×</button>
					...
					<div class="portlet box green">
						...
						<div class="portlet-body">
							...
							<div class="table-toolbar">
								<div class="btn-group">
									<button id="sample_editable_1_new" class="btn green" onclick="window.location='<?php echo $this->config->site_url();?>admin/practicalinfo/add'" >
								...
								<div class="btn-group pull-right">
									...
									<ul class="dropdown-menu pull-right">
										<li>
											<a onClick="return confirm_multiple('practicalinfo');">
												 <?php echo $this->lang->line('DELETE_ALL');?>
											</a>
										</li>
										<li>
											<a onClick="return confirm_active('practicalinfo');">
												 <?php echo $this->lang->line('ACTIVE_ALL');?>
											</a>
										</li>
										<li>
											<a onClick="return confirm_inactive('practicalinfo');">
							...
							<table class="table table-striped table-bordered table-hover" id="sample_2">
								<thead>
									<tr>
										...
										<th width="25%">
											<?php echo $this->lang->line('COUNTRY_CAT'); ?>
										</th>
										<th width="25%">
											<?php echo $this->lang->line('DETAILED_CAT'); ?>
										</th>
								...
								<tbody>
									<?php 
									foreach($practicalinfodata as $pdata){?>
									<tr class="odd gradeX">
										<td>
											<input type="checkbox" class="checkboxes" id="delete_rec[]" name="delete_rec[]" value="<?php echo $pdata['id']; ?>"/>
										</td>
										<td>
											<?php echo date('d M Y',strtotime($pdata['created_date'])); ?>
										</td>
										<td>
											<?php
											$modelproinfo = new Practicalinfomodel();
											$catname = $modelproinfo->getdestinationName($pdata['destination_id']);
											echo $catname; ?>
										</td>
										<td>
											<?php
											$modelproinfo = new Practicalinfomodel();
											$catname = $modelproinfo->getcatname($pdata['practical_information_id']);
											echo $catname; ?>
										</td>
										
										
										<td>
											 <a onclick="return confirm('<?php echo $this->lang->line('STATUS_COMFIRM'); ?>');"style="text-decoration: none;" href="<?php echo $this->config->site_url();?>admin/practicalinfo/update_status?id=<?php echo $pdata['id'];?>">
										...
										<td>
											 <a href="<?php echo $this->config->site_url();?>admin/practicalinfo/edit?id=<?php echo $pdata['id'];?>" class="btn default btn-xs green-stripe"><i class="fa fa-edit"></i> Edit</a>
											 <a  onclick="return confirm('<?php echo $this->lang->line('DELETE_COMFIRM'); ?>');" href="<?php echo $this->config->site_url();?>admin/practicalinfo/delete?id=<?php echo $pdata['id'];?>" class="btn default btn-xs green-stripe"><i class="fa fa-trash-o"></i> Delete</a>
										</td>
									</tr>
									<?php } ?>
								</tbody>
