		...
		<div class="page-content">
			...
			<div class="tab-pane" id="tab_7">
				 <div class="portlet box green ">
					...
					<form action="<?php echo $this->config->site_url();?>admin/practicalinfocategory/update" class="form-horizontal form-bordered form-label-stripped" id="practicalinfocategoryfrm" name="practicalinfocategoryfrm" method="post" enctype="multipart/form-data">
						<?php
						...
						<div class="form-body">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
								<?php 
									$modelclass =  new Practicalinfocategorymodel();
									...
									<select name="parent_id" id="parent_id" class="form-control select2me">
											...
											<option value="<?php echo $productcat['category_id'];?>" <?php if($selected_id  == $productcat['category_id']) echo "selected";?>><?php echo $productcat['category_name']; ?></option>
											<?php } ?>
									</select>
									<span class="help-block">
