<div class="clearfix">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="<?php echo $this->config->site_url();?>admin/product">
								<?php echo $this->lang->line('PRO_TITLE');?>
							</a>
							<i class="fa fa-angle-right"></i>
						</li>
						<li>
							<?php echo $productnames;?>
						</li>
			...
			<div class="row">
				<form action="<?php echo $this->config->site_url();?>admin/product/update"  id="productfrm" name="productfrm" method="post" enctype="multipart/form-data">
					<div class="col-md-6">
								...
								<div class="portlet-body form">
									 <div class="form-body">
											...
											<div class="form-group">
												...
												<input type="hidden" class="form-control select2_sample3" value="<?php if(isset($selected_primary_tag) && !empty($selected_primary_tag)){ echo $selected_primary_tag;}?>" id="primary" name="primary">
												<span class="help-block"><?php echo $this->lang->line('PRO_TAGS_HINT');?></span>
											</div>
											<div class="form-group">
												<input type="hidden" class="form-control select2s_sample3" value="<?php if(isset($selected_secoundry_tag) && !empty($selected_secoundry_tag)){ echo $selected_secoundry_tag;}?>" id="secondary" name="secondary">
											...
											<?php /*<div class="form-group">
													<label> <?php echo $this->lang->line('PRO_SELECT_USERDEATLS');?></label>
											...
											<div class="form-group">
													...
													<span>
														...
														?>
															<a href="<?php echo $this->config->base_url().'application/uploads/product/sidebarimage/original/'.$formdata["image_link_sidebar"]; ?>" class="group2"><?php echo $this->lang->line('VIEW_IMAGES');?></a>
															<?php 
														}else{
											...
											<div class="form-group">
													...
													<span>
														...
														?>
															<a href="<?php echo $this->config->base_url().'application/uploads/product/featuredimage/original/'.$formdata["featured_image"]; ?>" class="group2"><?php echo $this->lang->line('VIEW_IMAGES');?></a>
															<?php 
														}else{
															echo $this->lang->line('NO_IMAGES');
														}?>
