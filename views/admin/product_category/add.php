		...
		<div class="page-content">
			...
			<div class="tab-pane" id="tab_7">
				 <div class="portlet box green ">
					...
					<form action="<?php echo $this->config->site_url();?>admin/product_category/add" class="form-horizontal form-bordered form-label-stripped" id="productcatfrm" name="productcatfrm" method="post" enctype="multipart/form-data">
						<?php
						...
						<div class="form-body">
								...
								<div class="col-md-9">
									...
									if(isset($productcatdata) && !empty($productcatdata)){
										foreach($productcatdata as $productcatdatas){ ?>
											<option value="<?php echo $productcatdatas['category_id'];?>"><?php echo $productcatdatas['spacing']; ?><?php echo $productcatdatas['category_name'];?></option>
										<?php 
										}
									}?>
									</select>
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									...
									{
										?>
										<a href="<?php echo $this->config->base_url().'/application/uploads/destinationimage/categoryimage/'.$formdata["image"]; ?>" class="group2"><?php echo $this->lang->line('VIEW_IMAGES');?></a>
										<?php }
									else
									{
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									...
									{
										?>
										<a href="<?php echo $this->config->base_url().'/application/uploads/destinationimage/logodestination/'.$formdata["logo_destination"]; ?>" class="group2"><?php echo $this->lang->line('VIEW_IMAGES');?></a>
										<?php }
									else
									{
										echo $this->lang->line('NO_IMAGES');
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									...
									{
										?>
										<a href="<?php echo $this->config->base_url().'/application/uploads/destinationimage/homelogo/'.$formdata["logo_home"]; ?>" class="group2"><?php echo $this->lang->line('VIEW_IMAGES');?></a>
										<?php }
									else
									{
										echo $this->lang->line('NO_IMAGES');
