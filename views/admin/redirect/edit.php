		...
		<div class="page-content">
			...
			<div class="tab-pane" id="tab_7">
				 <div class="portlet box green ">
					...
					<form action="<?php echo $this->config->site_url();?>admin/redirect/update" class="form-horizontal form-bordered form-label-stripped" id="redirectfrm" name="redirectfrm" method="post" enctype="multipart/form-data">
						...
						<input type="hidden" name="url_id" id="url_id" value="<?php echo $formdata['id']; ?>"/> 		
					</form>
					<!-- END FORM-->
				</div>
			</div>
