		...
		<div class="page-content">
			...
			<div class="tab-pane" id="tab_7">
				 <div class="portlet box green ">
					...
					<form action="<?php echo $this->config->site_url();?>admin/tags/add" method="post" class="form-horizontal form-bordered form-label-stripped" id="tagfrm" name="tagfrm">
						...
						<div class="form-body">
							...
							<div class="form-group">
								<label class="control-label col-md-3"> <?php echo $this->lang->line('TAG_DESCRIPTION');?></label>
								<div class="col-md-9">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									...
									<span class="help-block">
										  <?php echo $this->lang->line('TAGS_SLIDER_HINT');?>
									</span>
								</div>
							</div>
