					...
					<div class="portlet box green">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="btn-group">
									<button id="sample_editable_1_new" class="btn green" onclick="window.location='<?php echo $this->config->site_url();?>admin/tags/add'" >
                                ...
                                <div class="btn-group pull-right">
									...
									<ul class="dropdown-menu pull-right">
										<li>
											<a onClick="return confirm_multiple('tags');">
												 <?php echo $this->lang->line('DELETE_ALL');?>
											</a>
										</li>
										<li>
											<a onClick="return confirm_active('tags');">
												 <?php echo $this->lang->line('ACTIVE_ALL');?>
											</a>
										</li>
										<li>
											<a onClick="return confirm_inactive('tags');">
							...
							<table class="table table-striped table-bordered table-hover" id="sample_2">
								<thead>
									<tr>
										...
										<th width="15%">
											 <?php echo $this->lang->line('TAG_TYPE_FIELD'); ?>
										</th>
										<th width="15%">
											 <?php echo $this->lang->line('TAG_PAGE_FIELD'); ?>
										</th>
										<th width="15%">
								...
								<tbody>
									...
									<tr class="odd gradeX">
										...
										<td>
												<?php echo $cdata['tag_name']; ?>
										</td>
										<td>
												<?php echo  ucfirst($cdata['tag_type']);?>
										</td>
										<td>
												
												<?php  
												if(isset($cdata['tag_page']) && !empty($cdata['tag_page']) && $cdata['tag_page'] == 'post')
												{
													echo  $this->lang->line('TAG_POST');
												}
												else if(isset($cdata['tag_page']) && !empty($cdata['tag_page']) && $cdata['tag_page'] == 'practical_information')
												{
													echo  $this->lang->line('TAG_PRACTICAL_INFO');
												}	?>
												
										</td>
										<td>
											 <a onclick="return confirm('<?php echo $this->lang->line('STATUS_COMFIRM'); ?>');"style="text-decoration: none;" href="<?php echo $this->config->site_url();?>admin/tags/update_status?id=<?php echo $cdata['id'];?>">
										...
										<td class="center">
											 <a href="<?php echo $this->config->site_url();?>admin/tags/edit?id=<?php echo $cdata['id'];?>" class="btn default btn-xs green-stripe"><i class="fa fa-edit"></i> Edit</a>
											 <a onclick="return confirm('<?php echo $this->lang->line('DELETE_COMFIRM'); ?>');" href="<?php echo $this->config->site_url();?>admin/tags/delete?id=<?php echo $cdata['id'];?>" class="btn default btn-xs green-stripe"><i class="fa fa-trash-o"></i> Delete</a>
										</td>
									</tr>
									<?php } ?>
								</tbody>
