		...
		<div class="page-content">
			...
			<div class="tab-pane" id="tab_7">
				 <div class="portlet box green ">
					...
					<form action="<?php echo $this->config->site_url();?>admin/userdetails/add" class="form-horizontal form-bordered form-label-stripped" id="userdetailsfrm" name="userdetailsfrm" method="post" enctype="multipart/form-data">
						<?php
						...
						<div class="form-body">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									...
									<span>
										...
										{
											?>
											<a href="<?php echo $this->config->base_url().'application/uploads/userimages/'.$formdata["image"]; ?>" class="group2"><?php echo $this->lang->line('VIEW_IMAGES');?></a>
											<?php }
										else
										{
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input id="show_home" name="show_home" class="checkboxes" type="checkbox"  value="1" >
									<span class="help-block">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<select id="show_home_position" name="show_home_position" class="form-control select2me">
										<option value="left"><?php echo $this->lang->line('LEFT');?></option>
										<option value="right"><?php echo $this->lang->line('RIGHT');?></option>
									</select>
									<span class="help-block">
