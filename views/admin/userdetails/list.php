			...
			<div class="row">
				<div class="col-md-12">
					...
					<?php 
							...
							$succ_update 	= $this->session->userdata('updatescc');
							$succ_update_status 	= $this->session->userdata('succ_update');
					 ...
					 <?php }
					 if(isset($succ_update_status) && !empty($succ_update_status)){ ?>
						<div class="alert alert-success">
							<button class="close" data-dismiss="alert">×</button>
					...
					<div class="portlet box green">
						...
						<div class="portlet-body">
							...
							<div class="table-toolbar">
								<div class="btn-group">
									<button id="sample_editable_1_new" class="btn green" onclick="window.location='<?php echo $this->config->site_url();?>admin/userdetails/add'" >
								...
								<div class="btn-group pull-right">
									...
									<ul class="dropdown-menu pull-right">
										<li>
											<a onClick="return confirm_multiple('userdetails');">
												 <?php echo $this->lang->line('DELETE_ALL');?>
											</a>
										</li>
										<li>
											<a onClick="return confirm_active('userdetails');">
												 <?php echo $this->lang->line('ACTIVE_ALL');?>
											</a>
										</li>
										<li>
											<a onClick="return confirm_inactive('userdetails');">
							...
							<table class="table table-striped table-bordered table-hover" id="sample_2">
								<thead>
									<tr>
										...
										<th width="30%">
											 <?php echo $this->lang->line('USERDETAILS_POSITION'); ?>
										</th>
										<th width="15%">
								...
								<tbody>
									<?php 
									foreach($userdetailsdata as $cdata){?>
									<tr class="odd gradeX">
										<td>
										...
										<td>
											<?php echo $cdata['user_name']; ?>
										</td>
										<td>
											<?php echo $cdata['position']; ?>
										</td>
										<td>
											<a onclick="return confirm('<?php echo $this->lang->line('STATUS_COMFIRM'); ?>');"style="text-decoration: none;" href="<?php echo $this->config->site_url();?>admin/userdetails/update_status?id=<?php echo $cdata['id'];?>">
										...
										<td>
											 <a href="<?php echo $this->config->site_url();?>admin/userdetails/edit?id=<?php echo $cdata['id'];?>" class="btn default btn-xs green-stripe"><i class="fa fa-edit"></i> Edit</a>
											 <a  onclick="return confirm('<?php echo $this->lang->line('DELETE_COMFIRM'); ?>');" href="<?php echo $this->config->site_url();?>admin/userdetails/delete?id=<?php echo $cdata['id'];?>" class="btn default btn-xs green-stripe"><i class="fa fa-trash-o"></i> Delete</a>
										</td>
									</tr>
									<?php } ?>
								</tbody>
