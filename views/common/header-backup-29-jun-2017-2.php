...
<link rel="stylesheet"  href="<?php echo $this->config->base_url();?>assets/front/css/style.css?version=52" type="text/css" />
<link rel="stylesheet"  href="<?php echo $this->config->base_url();?>assets/front/css/responsive.css" type="text/css" />
...
<?php
if(isset($urlsegment) && !empty($urlsegment) && $urlsegment == 'demandededevis') {?>
<script type="text/javascript">var jqfrm3=jQuery.noConflict();jqfrm3(document).ready(function(){jqfrm3("#from").Zebra_DatePicker({always_visible:jqfrm3("#container"),pair:jqfrm3("#to"),firstDay:1,direction:!0}),jqfrm3("#to").Zebra_DatePicker({selectWeek:!0,always_visible:jqfrm3("#container2"),direction:!0})}),jqfrm3(function(){jqfrm3("#slider").nivoSlider({effect:"fade",slices:1,boxCols:8,boxRows:4,animSpeed:500,pauseTime:3000,startSlide:0,directionNav:true,directionNavHide:false,controlNav:true,keyboardNav:true,pauseOnHover:true,manualAdvance:false})});</script>
<?php }else{ ?>	
