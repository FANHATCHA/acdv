...
<body>
	...
	if(isset($urlsegment) && !empty($urlsegment) && $urlsegment != 'demandededevis'){
        ...
        <div class="if_not_homepage">
			<div class="contact-btn">
				<div class="quotestion_frm_mobile">
					<a href="<?php echo $this->config->base_url().'demandededevis';?>"><?php echo $this->lang->line('RECEVEZ_ALL_PAGES_BUTTON_HOME');?></a>
				</div>
		...
		<div class="if_not_homepage">
			<div class="contact-btn">
				<div class="quotestion_frm_mobile">
					<a onclick="fillpurlstring();"><?php echo $this->lang->line('RECEVEZ_ALL_PAGES_BUTTON_HOME');?></a>
				</div>
			</div>
		</div>	
