                                ...
                                <div class="top-field-cols_right">    
	                                <div class="top-field">    
    	                                <div class="top-field-cols">    
        	                                <input type="text" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;" name="name" id="name" value="Votre nom complet">
...
function validationfrm()
{
	...
	if(!name && name.length < 0 || name == "Votre nom complet"){
	   isValid = false;
	   if(!focusOn)
	   {
		focusOn=document.getElementById("name");
	   }
	   jqfrm("#msg_name").html("Veuillez entrer votre nom complet").show();
