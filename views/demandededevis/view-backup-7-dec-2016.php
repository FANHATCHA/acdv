                        ...
                        <li class="demandededevis_step5">    
                            ...
                            <div>    
                                ...
                                <div class="fclear">    
									...
									<?php /*<div class="captcha_main">
										<img class="captcha_codeclass_image" src="<?php echo $this->config->site_url();?>application/views/contact/imagebuilder.php">
										
										<input class="captcha_form_text" type="text" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;" name="captcha" id="captcha" placeholder="Merci de recopier le texte ci-contre">
