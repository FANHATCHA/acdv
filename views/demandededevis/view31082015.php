...

{
	...
	/*var comment = jqfrm("#comment").val();

	if(!comment && comment.length <= 0 || comment == "S'agit-il de votre voyage de noces ? Que souhaiteriez vous modifier ou ajouter a votre voyage ?...."){
...

	   {
		...
		focusOn=document.getElementById("comment");

	   }

	   jqfrm("#msg_comment").html("Please enter comment").show();

	}else{

	   jqfrm("#msg_comment").html("").hide();
