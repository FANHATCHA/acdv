...
/*function filter_products(filter_element)
{
	...
	if(filterdata[0] == 'prix')
	{
		...
		{
			document.getElementById("filter_option").value =  "&price=ASC";
		...
		{
			document.getElementById("filter_option").value =  "&price=DESC";
	...
	{	
		...
		{
			document.getElementById("filter_option").value =  "&hits=ASC";
		...
		{
			document.getElementById("filter_option").value =  "&hits=DESC";
