...
<form action="<?php echo $this->config->base_url();?>contact/requestquotefrm" method="post" name="requestfrm" id="requestfrm" >
		...
		<div id="wizard" class="swMain">
			...
			<div id="step-5">
				...
				<textarea id="comment" name="comment" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;">Cliquer ici pour préciser votre ville de départ,....</textarea>              			
