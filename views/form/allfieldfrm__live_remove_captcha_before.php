			...
			<div id="step-5">
                ...
                <div class="step-5-row">
					...
					<div class="captcha_main">
						...
						<input class="captcha_form_text" onclick="check_captchacode();" onfocus="check_captchacode();" onblur="check_captchacode();" onkeypress="check_captchacode();" onKeyUp="check_captchacode();" type="text" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;" name="captcha" id="captcha" placeholder="Merci de recopier le texte ci-contre">
