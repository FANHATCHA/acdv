...
$(document).ready(function() {
	...
	$('#blog-details').load("<?php echo $this->config->site_url();?>ajaxcall/autoload_categoryblogdata", {'group_no': track_load,'catid': catid}, function() {track_load++;}); //load first group
	$(window).scroll(function() { //detect page scroll
		if($(window).scrollTop() + $(window).height() > $(document).height() - scrollminisheight)  //user scrolled to bottom of the page?  //user scrolled to bottom of the page?
		{
			if(track_load <= total_groups && loading==false) //there's more data to load
			{
				...
				$.post('<?php echo $this->config->site_url();?>ajaxcall/autoload_categoryblogdata',{'group_no': track_load,'catid': catid}, function(data){
