...
$(document).ready(function() {
	...
	/*$.ajax({
      url: "<?php echo $this->config->site_url();?>ajaxcall/autoload_blogdata",
      type: "post",
	...
	/*$('#blog-details').load("<?php echo $this->config->site_url();?>ajaxcall/autoload_blogdata", {'group_no': track_load}, function() {track_load++;}); //load first group
	$(window).scroll(function() { //detect page scroll
		...
		if($(window).scrollTop() + $(window).height() > $(document).height() - scrollminisheight)  //user scrolled to bottom of the page?
		{
			if(track_load <= total_groups && loading==false) //there's more data to load
			{
				...
				$.post('<?php echo $this->config->site_url();?>ajaxcall/autoload_blogdata',{'group_no': track_load}, function(data){
