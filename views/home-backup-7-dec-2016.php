...
<div id="content">
	...
	<div class="gallery_bg_mn demo">
		<div class="wrapper">        
			<div class="gallery_bg_mn_row">
				...
				<div class="small">
					<a href="http://www.aucoeurduvoyage.com/destination/la-reunion"><img width="340" height="340" src="http://www.aucoeurduvoyage.com/assets/front/images/home-gallery/La-Reunion.jpg" alt="La Réunion"/>
						<div class="mask">
							...
							<button class="btn-gallery">Nos voyages à la Réunion</button></a>
						</div>
			...
			<div class="view view-first home_gallry_small_box1">
				<div class="medium">
					...
					<div class="mask">
						...
						<button class="btn-gallery">Direction les Etats-Unis</button></a>
                    </div>
			...
			<div class="view view-first home_gallry_small_box2">
				<div class="big">
					...
					<div class="mask">
						...
						<button class="btn-gallery">Nos Voyages de Noces</button></a>
                    </div>
				</div>
			</div>
			<div class="view view-first home_gallry_small_box">
				<div class="small">
					...
					<div class="mask">
						...
						<button class="btn-gallery">Nos voyages en Indonésie</button></a>
                    </div>
				</div>
			</div>
			<div class="view view-first home_gallry_small_box">
				<div class="small">
					...
					<div class="mask">
						...
						<button class="btn-gallery">Découvrez l'Ile Maurice</button></a>
                    </div>
				</div>
			</div>
			<div class="view view-first home_gallry_small_box">
				<div class="small">
					...
					<div class="mask">
						<p>Partez à la rencontre de paysages somptueux et de monuments au charme authentique</p>
						<button class="btn-gallery">Direction le Cambodge</button></a>
                    </div>
				</div>
			</div>
			<div class="view view-first home_gallry_small_box1">
				<div class="medium">
					...
					<div class="mask">
						...
						<button class="btn-gallery">Nos voyages en Polynésie</button></a>
                    </div>
				</div>
			</div>
			<div class="view view-first home_gallry_small_box">
				<div class="small">
					<a href="http://www.aucoeurduvoyage.com/type-de-voyage/croisiere"><img width="340" height="340" src="http://www.aucoeurduvoyage.com/application/uploads/images/original/croisiere-voyage-catamaran-home.jpg" alt="Croisière"/>
					<div class="mask">
						<p>Offrez-vous un séjour inoubliable à bord d'une de nos somptueuses croisières</p>
						<button class="btn-gallery">Voguez sur nos croisières</button></a>
                    </div>
				</div>
			</div>
		</div>
				...
				<?php $sk = 1; foreach($PromotingOffers as $PromotingOffer){ 
					...
					<li>
						...
						<div class="Offre_specials_mn_row1">
							<?php if(isset($productprice) && !empty($productprice)){?><span class="pricetitle">Votre s&eacute;jour &agrave; partir de</span><div class="Offre_price"><?php echo $productprice;?>&euro;</div><?php } ?>
							...
							<div class="countdown">
								...
								<script type="text/javascript">
									...
									if(fulldate != ''){
										if(typeof(count_downs) == 'function'){
							...
							<?php }else{?>
							<div class="countdown">	
								<a href="<?php echo $productdetailslink;?>">Réservez maintenant</a>
							</div>	
							<?php } }else{ ?>
							<div class="countdown">	
								<a href="<?php echo $productdetailslink;?>">Réservez maintenant</a>
	...
	<div class="communautpart">
		<div class="wrapper">
			<div class="La_Communaute_mn">
				<div class="La_Communaute_mn_title"><h2>La Communaut&eacute;</h2>
				<h3>Au Coeur du Voyage</h3></div>
						...
						if(isset($clientreview) && !empty($clientreview))
						{
							...
							{?>
								...
								<p class="review_title"><?php echo $clientreviews['name'];?></p>
									...
									?>
									<p class="review_text"><?php echo string_limit($clientreviews['client_review'],300);?></p>
									<p class="review_link"><a href="<?php echo $this->config->base_url();?>lavis-de-nos-clients">Lire la suite</a></p>
								</li>
								<?php }else{ ?>
								<li>
								<p class="review_title"><?php echo $clientreviews['name'];?></p>
				...
				<div class="comment_right_mn">
					<div class="gposts">
						<iframe src="//www.facebook.com/plugins/likebox.php?href=https%3A%2F%2Fwww.facebook.com%2Fpages%2FAu-Coeur-Du-Voyage%2F233613626680309&amp;width=486&amp;height=258&amp;colorscheme=light&amp;show_faces=false&amp;header=false&amp;stream=false&amp;show_border=false" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:486px; height:75px;" allowTransparency="false"></iframe>
					</div>
