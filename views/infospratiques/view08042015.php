		...
		<div class="info_tabing_web">
			...
			<div class="proinfo-brd">
				<div class="breadcrumbs">
					<a href="<?php echo $this->config->base_url();?>"><span>Accueil</span></a> > <a href="<?php echo $this->config->base_url().'destination/'.$destslug[0];?>"><span><?php echo ucfirst($destinationname);?></span></a> > <span><?php echo ucfirst($infopagename);?></span>
				</div>
			</div>
