...
<div class="representatives_mn">
	<div class="wrapper">
		...
		<!--<div class="Notre_Savoir_row">

			<h2>Notre Savoir-<span>Faire</span></h2>

			<p>Au Coeur Du Voyage est un tour-op&eacute;rateur sp&eacute;cialis&eacute; dans <b>l&rsquo;Oc&eacute;an Indien, la Polyn&eacute;sie fran&ccedil;aise, l&rsquo;Asie et les &Eacute;tats-Unis.</b> Nous proposons <span>des s&eacute;jours sur mesure o&ugrave; tout est &agrave; la carte</span> (excursions, h&ocirc;tels ou encore visites). Nos conseillers sont l&agrave; pour vous guider tout au long de l&rsquo;&eacute;laboration de votre voyage en tenant compte de vos attentes afin de d&eacute;finir avec vous le voyage qui vous ressemble, en d&rsquo;autres termes, <span>le voyage de vos r&ecirc;ves.</span></p>

		</div>

		

		<div class="Notre_Savoir_cols_main">

			<div class="Notre_Savoir_cols">

				<a href="#des-voyages">

					<span><img alt="" src="<?php echo $this->config->base_url();?>application/uploads/medialibrary/images/icon5.png" /></span>

					<h3>Des voyages<br />&agrave; la carte</h3>
			...
			<div class="Notre_Savoir_cols">
				...
				<a href="#des-conseillers">

				<span><img alt="" src="<?php echo $this->config->base_url();?>application/uploads/medialibrary/images/icon6.png" /></span>

				<h3>Des conseillers<br />sp&eacute;cialistes de leurs<br />destinations</h3>
			...
			<div class="Notre_Savoir_cols">
				...
				<a href="#une-assistance">

				<span><img alt="" src="<?php echo $this->config->base_url();?>application/uploads/medialibrary/images/icon7.png" /></span>

				<h3>Une assistance<br />24/24 sur place</h3>
